...
class ProgrammingLanguageAdapter(
    programmingLanguages: MutableList<ProgrammingLanguage>,
    listener: View.OnClickListener
) : RecyclerView.Adapter<ProgrammingLanguageAdapter.ViewHolder>() {

    private val programmingLanguages: MutableList<ProgrammingLanguage> = programmingLanguages
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bindView(
            ...
            tvLaunchYear.text = programmingLanguage.ano.toString()
